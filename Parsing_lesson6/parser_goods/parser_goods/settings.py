...
USER_AGENT = 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/103.0.5060.134 Safari/537.36 OPR/89.0.4447.91'
...
ITEM_PIPELINES = {
    ...
    'parser_goods.pipelines.CitilinkPhotosPipeline': 200,
}
